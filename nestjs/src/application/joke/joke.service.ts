...
} from '../../domain/external-joke/external-joke.service.interface';
...
export class JokeService {
  ...
  async create(
    ...
    const jokeEntity: JokeEntity = JokeEntity.create({
      userId,
      ...createJokeDto,
    });
    return this.jokeMapper.toApiDto(await this.jokeRepository.save(jokeEntity));
  }
